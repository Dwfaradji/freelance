import { BlogProps } from "@/app/Data/typeFile";
import imagesBlog from "@/app/Assets/GalleryBlog";
...
const blog: BlogProps[] = [
  ...
  },
  {
    ...
    image: String(imagesBlog.blog2),
    alt: "image_blog_les_avantages_de_creer_un_site_sans_cms",
    readingTime: 5,
    category: "category 2",
    date: "12-07-2023",
  },
  {
    id: 3,
    title: "Pourquoi engager un développeur web freelance ?",
    descriptionShort:
    ...
    image: String(imagesBlog.blog3),
    alt: "image_blog_faire_appel_a_un_developpeur_web_freelance",
    readingTime: 5,
    category: "category 3",
    date: "13-07-2023",
  },
