...
const config = {
  ...
  description: "Ce site utilise des cookies ou des technologies similaires pour améliorer votre expérience de navigation et fournir des recommandations personnalisées. En continuant à utiliser notre site, vous acceptez notre politique de confidentialité et notre consentement aux cookies",
...
const headerScripts = [
  {
    ...
    type: "analytics",
    value: "https://www.googletagmanager.com/gtag/js?id=G-3ZMKMEH64J"
  }
];
