...
const Navbar = () => {
    ...
    useEffect(() => {
        window.addEventListener('scroll', function () {
            if (window.scrollY > 100) { // Exemple : changer l'état lorsque le scroll dépasse 100px
                setColorLogo("colorP")
            } else {
                setColorLogo("colorS")
            }
    ...
    return (
        <nav className="bg-transparent fixed top-0 z-10 left-0 right-0 w-full text-blue backdrop-blur-lg">
