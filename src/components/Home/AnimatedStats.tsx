...
const AnimatedStats = () => (
  <section className="mt-10 grid size-full  grid-cols-1 justify-between  gap-4  md:grid-cols-4">
    <Fade cascade>
      <div className="flex size-full flex-col content-center justify-center rounded-xl bg-gradient-to-r from-lightblack to-lightblack p-5 text-center align-middle transition duration-500 ease-in-out hover:from-purple hover:to-pink ">
