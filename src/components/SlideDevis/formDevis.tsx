            ...
            <div className="question mb-6" key={question.id}>
              ...
              <div className="mt-3 flex ">
                <div className="me-2 flex items-center ">
                  <input
                    type="radio"
                    className="text-blue-600 focus:ring-primary dark:focus:ring-blue-600 size-4 border-gray-300 bg-gray-100 focus:ring-2 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800"
