        ...
        <div className="mt-10 flex flex-wrap md:flex-nowrap">
          <div className="m-2 w-full rounded-xl bg-lightblack p-8 text-white md:w-2/4">
            ...
            <p className="mt-5 opacity-70">
              ...
              <br />
              📈 Résultats : une expérience utilisateur exceptionnelle, avec un
              tableau de bord permettant aux agents de modeler leur espace
      ...
      <Fade cascade>
        <div className="mt-10 flex flex-row-reverse flex-wrap md:flex-nowrap">
          <div className="m-2 w-full rounded-xl bg-lightblack p-8 text-white md:w-2/5">
            ...
            <h1 className="text-5xl font-bold">Création Carousel Youtube.</h1>
            <p className="mt-5 opacity-70">
              🚀{' '}
              ...
              <br />
              🛠️ Notre mission : concevoir une application web flexible pour la
              gestion efficace des projets et des équipes, avec des
              ...
              communications en temps réel et MongoDB pour une gestion efficace
              des données.
              <br />
              ...
              mises à jour fréquentes basées sur les retours des utilisateurs et
              une intégration continue via GitLab.
              <br />
      ...
      <Fade cascade>
        <div className="mt-10 flex flex-wrap md:flex-nowrap">
          <div className="m-2 w-full rounded-xl bg-lightblack p-8 text-white md:w-2/4">
            ...
            <h1 className="text-5xl font-bold">{"Création d'application"}</h1>
            <p className="mt-5 opacity-70">
              ...
              esthétiquement attrayante prête à propulser votre entreprise vers
              de nouveaux sommets de réussite.
            </p>
            <br />
