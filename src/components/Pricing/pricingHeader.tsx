...
const PricingHeader = () => {
    return (
        <header className="max-w-7xl mx-auto mt-10 font-poppins text-white flex flex-col items-center">
            <Fade>
            ...
            <Fade cascade>
                <div className="grid grid-cols-2 gap-4 mt-10 xxs:grid-cols-1 sm:grid-cols-2">
                    <div className="bg-lightblack p-10 rounded-xl flex flex-col justify-between">
                        ...
                        <h2 className="text-4xl mt-2 font-bold">49€/Mois</h2>
                        <h2 className="text-sm mt-2 opacity-50">
                    ...
                    <div className="bg-lightblack p-10 rounded-xl flex flex-col justify-between">
                        ...
                        <h2 className="text-4xl mt-2 font-bold">25€/An</h2>
                        <h2 className="text-sm mt-2 opacity-50">
